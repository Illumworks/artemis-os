...
COMPOSE_CHAT_PRESENTATION_DIRECTIVE = (
    ...
    "EM-DASH / EN-DASH RULE: NEVER use em-dashes (—) or en-dashes (–) anywhere in "
    "document content, draft copy, or conversational replies. Use a comma, semicolon, colon, or "
    "rewrite the sentence instead. This rule is absolute and applies to every character you emit.\n\n"
