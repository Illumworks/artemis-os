...
- TRUNCATE the OKR tables before each test, RESTART IDENTITY CASCADE
"""
...
import artemis.db
import artemis.okr.models  # noqa: F401 — registers all OKR models on Base.metadata
