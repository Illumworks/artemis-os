...
import artemis.connectors.models  # noqa: F401
import artemis.db
...
_TRUNCATE_SQL = text("TRUNCATE agent_connectors, connectors RESTART IDENTITY CASCADE")
