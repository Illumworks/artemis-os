...
import artemis.automations.models  # noqa: F401 — register models on Base.metadata
import artemis.builders.models  # noqa: F401 — register builder models (target tables)
import artemis.db
...
_TRUNCATE_SQL = text("TRUNCATE automation_runs, automations RESTART IDENTITY CASCADE")
