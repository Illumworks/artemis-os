...
import map in `public/index.html` resolves them back to these local files so every
package shares one copy of each PM class (`instanceof EditorState` keeps working).
