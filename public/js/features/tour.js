// Guided tour — uses Driver.js to walk users through Artemis features
const TOUR_KEY = 'artemis-tour-completed';
...
function buildSteps() {
  ...
  // ── Sidebar & Navigation ──────────────────────────
  {
    element: '[data-app-view="dashboard"]',
    popover: {
      title: 'Dashboard',
      description: 'The top-level landing shell for Morning Brief, Task Command, Needs Attention, and the workspace modules.',
      side: 'right',
      align: 'center',
    },
  },
  {
    element: '#status-orb-btn',
    popover: {
      title: 'System Status',
      description: 'Open the live status popover for providers, connectors, and automation health.',
      side: 'right',
      align: 'center',
    },
  },
  ...
  {
    element: '#header-project-pill-btn',
    popover: {
      title: 'Session Config',
      description: 'Open the session config menu for source, approval, model, max turns, disabled tools, and Run in parallel.',
      side: 'right',
      align: 'center',
    },
  },
  ...
  },
  {
    ...
    popover: {
      title: 'Tips Feed',
      description: 'Contextual tips and learning resources to help you get more out of Artemis. <kbd>Cmd+Shift+T</kbd>',
      side: 'bottom',
      align: 'center',
    },
  },
  ...
  // ── Chat Area ─────────────────────────────────────
  {
    element: 'button[data-app-view="operations"]',
    popover: {
      title: 'Operations',
      description: 'Open the operating-system container for Automations, Skills, Agents, Workflows, and Memory.',
      side: 'top',
      align: 'center',
    },
  },
