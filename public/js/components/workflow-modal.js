    ...
    <div class="modal agent-form-modal">
      ...
      <form id="wf-form">
        <div class="af-preview-note">
          Create a repeatable preview flow made of saved prompt steps. For now it still runs with the provider and model selected in the main composer, and deeper flow controls are deferred.
        </div>
...
customElements.define('artemis-workflow-modal', WorkflowModal);
