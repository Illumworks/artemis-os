  ...
  <div id="agent-modal" class="modal-overlay hidden">
    <div class="modal agent-form-modal">
      ...
      <form id="agent-form">
        ...
        <div class="af-section">
          <div class="af-section-label">Model</div>
          <div class="af-grid-2">
            <div class="af-field">
              <label for="agent-form-provider">Provider</label>
              <select id="agent-form-provider">
            ...
            <div class="af-field">
              <label for="agent-form-model">Model</label>
...
customElements.define('artemis-agent-modal', AgentModal);
