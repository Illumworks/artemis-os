...
class ArtemisShortcutsModal extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <div id="shortcuts-modal" class="modal-overlay hidden">
        <div class="modal">
          ...
          <table class="shortcuts-table">
            ...
            <tr><td><span class="kbd">&#8984;&#8679;A</span></td><td>Go to Dashboard</td></tr>
...
customElements.define('artemis-shortcuts-modal', ArtemisShortcutsModal);
