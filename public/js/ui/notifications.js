...
const STORAGE_KEY = 'artemis-notifications';
const SOUND_KEY = 'artemis-notifications-sound';
...
export async function toggleNotifications() {
  ...
  if (!current) {
    ...
    if (window.location.protocol !== 'https:' && window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1') {
      alert('Notifications require HTTPS or localhost. Please access Artemis via https:// or http://localhost.');
      return false;
    }
