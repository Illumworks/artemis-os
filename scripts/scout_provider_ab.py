...
ITEMS = [
    (
        ...
        "https://news-gazette.com/champaign-unit-4-superintendent",
        "2026-09-03",
        "News-Gazette",
    ),
    (
        ...
        "https://michiganadvance.com/m-step-reading-2026",
        "2026-09-05",
        "Michigan Advance",
    ),
    (
        ...
        "https://sareport.org/saisd-dual-language-2026",
        "2026-08-28",
        "San Antonio Report",
    ),
    (
        ...
        "https://pcsb.org/procurement/rfp-26-014-DS",
        "2026-09-04",
    ...
    (
        ...
        "https://baltimoresun.com/bcps-superintendent-named",
        "2026-09-08",
        "Baltimore Sun",
    ),
]
...
async def main() -> None:
        ...
        row = (
            await s.execute(
                sqltext(
                    ...
                    "where agent_id='marketing.scout.regional_news'"
                )
            )
        ).one()
    ...
    for headline, body, url, published, publisher in ITEMS:
        ...
        try:
            ...
            reasons.append(
                f"JSON: {type(exc).__name__} (len={len(raw)}, "
        ...
        try:
            ...
            valid += 1
            print(
                f"  [{_sig.urgency_tier}] district={_sig.district_id!r} state={_sig.state_code!r}"
            )
    ...
    print(f"=== {which} :: {model} ===")
    print(
        f"  fenced {fenced}/{n}   closed-fence {closed}/{n}   json-parsed {parsed}/{n}   "
